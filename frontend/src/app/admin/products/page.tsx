...
import { ArrowLeft, Plus, Pencil, Trash2, ShoppingCart } from "lucide-react";
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span
                    className={`text-xs ${
                      product.stockQuantity === 0 ? "text-red-500" : "text-gray-400"
                    }`}
                  >
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <Trash2 size={14} /> {deletingId === product.id ? "..." : "Delete"}
                  </button>
                </div>
              </div>
            ))}
